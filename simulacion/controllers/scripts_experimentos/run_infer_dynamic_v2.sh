#!/bin/bash
# Inferencia dinámica v2 — modelos reentrenados con Opción 1 + Opción A
# STH-WP: run003_sXX_stage6_din_v2_final  | warehouse_1.wbt
# SUB-WP: subwp_sXX_wp75_stage6_din_v2_final | warehouse_1_subwp.wbt
# 100 ep/goal × 28 goals × 3 seeds × 2 métodos = 16800 ciclos totales
# Uso: bash run_infer_dynamic_v2.sh
...
echo "======================================================="
echo " INFERENCIA DINÁMICA v2 — Opción 1 + Opción A"
...
# ── STH-WP ────────────────────────────────────────────────────────────────────
run_sthwp "infer_r3_s42_s6din_v2"  "Inferencia din v2 — seed=42"
run_sthwp "infer_r3_s123_s6din_v2" "Inferencia din v2 — seed=123"
run_sthwp "infer_r3_s524_s6din_v2" "Inferencia din v2 — seed=524"

# ── SUB-WP ────────────────────────────────────────────────────────────────────
run_subwp "infer_din_v2_s42"  "Inferencia din v2 — seed=42"
run_subwp "infer_din_v2_s123" "Inferencia din v2 — seed=123"
run_subwp "infer_din_v2_s524" "Inferencia din v2 — seed=524"

echo ""
echo "======================================================="
echo " INFERENCIA COMPLETA — $(date '+%Y-%m-%d %H:%M:%S')"
echo " CSVs STH-WP:"
echo "   $STHWP_DIR/inferencia_sthwp/resultados/infer_run003_s{42,123,524}_stage6_din_v2.csv"
echo " CSVs SUB-WP:"
echo "   $SUBWP_DIR/inferencia_subwp/resultados/infer_din_v2_s{42,123,524}.csv"
echo "======================================================="
