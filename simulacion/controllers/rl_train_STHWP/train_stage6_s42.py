"""
ETAPA 6 — Ciclo completo estático (approach→exit→return).  1M steps  |  SEED=42

Requiere: pruebas/run002_s42_stage4v2_final.zip
...
Salida: pruebas/run002_s42_stage6_final.zip
"""
