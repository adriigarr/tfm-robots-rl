"""
Inferencia ciclo completo dinámico v2_cont — run003 seed=42 — modelo stage6_din_v2_cont.

Modelo continuado 3M steps desde din_v2_final (48 dims, ~4M steps totales).
Carga: din_v2_cont_final (seed=42 se mantiene estable — no hay pico intermedio).
...
Salida: inferencia_sthwp/resultados/infer_run003_s42_stage6_din_v2_cont.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas",
                          "run003_s42_stage6_din_v2_cont_final")
RUN_ID     = "run003_s42_din_v2_cont"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s42_stage6_din_v2_cont.csv")
...
print(f"\n{'='*60}")
print(f" Inferencia DINÁMICA v2_cont | {RUN_ID}")
