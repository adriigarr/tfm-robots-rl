"""
Inferencia dinámica v3 + REPLANIFICACIÓN — STH-WP s42.

Checkpoint: run003_s42_stage6_din_v3_4101792_steps
Baseline v3 sin replanning: 35.7%

Salida: inferencia_sthwp/resultados/infer_run003_s42_stage6_din_v3_replanning.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas",
                          "checkpoints_run003_s42_stage6_din_v3",
                          "run003_s42_stage6_din_v3_4101792_steps")
RUN_ID   = "run003_s42_din_v3_replanning"
N_POR_GOAL = 100
OUT_DIR  = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH = os.path.join(OUT_DIR, "infer_run003_s42_stage6_din_v3_replanning.csv")
...
print(f"\n  COMPARATIVA:")
print(f"    v3 sin replanning (baseline):  35.7%")
