"""
Inferencia ciclo completo — run003 seed=524 — stage 6 (modelo unificado).
...
Salida: inferencia_sthwp/resultados/infer_run003_s524_stage6.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s524_stage6.csv")
