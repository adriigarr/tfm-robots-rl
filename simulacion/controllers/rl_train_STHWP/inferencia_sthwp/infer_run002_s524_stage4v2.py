"""
Inferencia stage 4 v2 — run002 seed=524 — CICLO COMPLETO ENCADENADO.

Modelo base: run002_s524_stage4v2_final (entrenado desde stage 3 v2).
100 episodios por goal × 28 goals = 2800 episodios.
Éxito = approach + exit completados en un único episodio encadenado.

Salida: inferencia_sthwp/resultados/infer_run002_s524_stage4v2.csv
"""
...
MODEL_PATH    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run002_s524_stage4v2_final")
RUN_ID        = "run002_s524"
STAGE         = 4
HEADING_SIGMA = 0.25
N_POR_GOAL    = 100
OUT_DIR       = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH      = os.path.join(OUT_DIR, "infer_run002_s524_stage4v2.csv")
