"""
Inferencia v1 estático + REPLANIFICACIÓN — STH-WP s123, peatones congelados.

Modelo: run003_s123_stage6_final (v1, ped_obs=False, 40 dims).
Peatones: físicamente presentes pero congelados.
Replanning activo. Aísla efecto del replanning sin entrenamiento dinámico.

Salida: inferencia_sthwp/resultados/infer_run003_s123_stage6_static_replanning.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "run003_s123_stage6_final")
RUN_ID   = "run003_s123_static_replanning"
N_POR_GOAL = 100
OUT_DIR  = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH = os.path.join(OUT_DIR, "infer_run003_s123_stage6_static_replanning.csv")
