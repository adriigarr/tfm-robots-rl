"""
Inferencia stage 5 — run002 seed=524 — RETORNO PURO (descarga→espera).

Modelo base: run002_s524_stage5_final (entrenado sobre stage4v2_final).
...
Salida: inferencia_sthwp/resultados/infer_run002_s524_stage5.csv
"""
...
MODEL_PATH    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run002_s524_stage5_final")
RUN_ID        = "run002_s524"
HEADING_SIGMA = 0.25
N_TOTAL       = 300
OUT_DIR       = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH      = os.path.join(OUT_DIR, "infer_run002_s524_stage5.csv")
