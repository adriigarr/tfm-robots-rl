"""
Inferencia ABLACIÓN — STH-WP s123 — v2_cont con peatones en posición FIJA.
...
Salida: inferencia_sthwp/resultados/infer_run003_s123_stage6_din_v2_cont_fixedped.csv
"""
...
RUN_ID     = "run003_s123_din_v2_cont_fixedped"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s123_stage6_din_v2_cont_fixedped.csv")
