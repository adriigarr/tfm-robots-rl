"""
Inferencia ciclo completo dinámico v2 — run003 seed=524 — modelo stage6_din_v2.

Modelo reentrenado con peatones activos + posición aleatoria + obs peatones (48 dims).
...
Salida: inferencia_sthwp/resultados/infer_run003_s524_stage6_din_v2.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "run003_s524_stage6_din_v2_final")
RUN_ID     = "run003_s524_din_v2"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s524_stage6_din_v2.csv")
...
print(f"\n{'='*60}")
print(f" Inferencia DINÁMICA v2 (retrained) | {RUN_ID}")
