"""
Inferencia stage 3 v2 — run002 seed=123 — política determinista.

Diferencias respecto a stage3 original:
  - Modelo: run002_s123_stage3v2_final (headings reales + reward marcha atrás)
...
Salida: inferencia_sthwp/resultados/infer_run002_s123_stage3v2.csv
"""
...
MODEL_PATH    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run002_s123_stage3v2_final")
RUN_ID        = "run002_s123"
STAGE         = 3
HEADING_SIGMA = 0.25
N_POR_GOAL    = 100
OUT_DIR       = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH      = os.path.join(OUT_DIR, "infer_run002_s123_stage3v2.csv")
