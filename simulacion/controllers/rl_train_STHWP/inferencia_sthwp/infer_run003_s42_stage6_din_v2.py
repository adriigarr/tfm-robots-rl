"""
Inferencia ciclo completo dinámico v2 — run003 seed=42 — modelo stage6_din_v2.
...
Salida: inferencia_sthwp/resultados/infer_run003_s42_stage6_din_v2.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "run003_s42_stage6_din_v2_final")
RUN_ID     = "run003_s42_din_v2"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s42_stage6_din_v2.csv")
