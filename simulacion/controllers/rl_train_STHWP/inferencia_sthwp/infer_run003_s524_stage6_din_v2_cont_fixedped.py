"""
Inferencia ABLACIÓN — STH-WP s524 — v2_cont con peatones en posición FIJA.

Modelo: checkpoint paso 2501472 (pico), 48 dims.
...
Propósito: aislar el efecto de la randomización. Si el éxito sube mucho
respecto a la inferencia con peatones aleatorios (40.4%), la randomización
durante entrenamiento era la clave del aprendizaje. Si es similar, la política
es genuinamente robusta a cualquier posición inicial.

Salida: inferencia_sthwp/resultados/infer_run003_s524_stage6_din_v2_cont_fixedped.csv
"""
...
RUN_ID     = "run003_s524_din_v2_cont_fixedped"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s524_stage6_din_v2_cont_fixedped.csv")
