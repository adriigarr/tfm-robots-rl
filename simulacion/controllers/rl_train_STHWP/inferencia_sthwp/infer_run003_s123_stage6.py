"""
Inferencia ciclo completo — run003 seed=123 — stage 6 (modelo unificado).
...
Salida: inferencia_sthwp/resultados/infer_run003_s123_stage6.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s123_stage6.csv")
