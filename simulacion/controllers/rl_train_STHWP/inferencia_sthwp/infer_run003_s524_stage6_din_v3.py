"""
Inferencia ciclo completo dinámico v3 — run003 seed=524 — recompensa B1.

Checkpoint seleccionado: paso 2,801,472 (más cercano al pico 38.9% en step 2,827,104).
El modelo final retiene 27.4% — también se incluye en dispatcher para comparar.
100 ep × 28 goals = 2800 ciclos. World: warehouse_1.wbt (PEDESTRIAN_1 + PEDESTRIAN_2).

Salida: inferencia_sthwp/resultados/infer_run003_s524_stage6_din_v3.csv
"""
...
RUN_ID     = "run003_s524_din_v3"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s524_stage6_din_v3.csv")
