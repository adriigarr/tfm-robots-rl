"""
Inferencia ciclo completo dinámico v2_cont — run003 seed=123 — checkpoint pico.

Modelo continuado 3M steps desde din_v2_final (48 dims).
Carga: checkpoint en paso 2501472 (pico de reward/éxito — 235 reward, 38% éxito ult100).
...
Salida: inferencia_sthwp/resultados/infer_run003_s123_stage6_din_v2_cont.csv
"""
...
RUN_ID     = "run003_s123_din_v2_cont"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s123_stage6_din_v2_cont.csv")
