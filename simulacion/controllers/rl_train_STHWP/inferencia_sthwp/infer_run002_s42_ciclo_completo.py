"""
Inferencia ciclo completo — run002 seed=42 — INICIO → ESTANTERÍA → DESCARGA → INICIO.
...
Salida: inferencia_sthwp/resultados/infer_run002_s42_ciclo_completo.csv
"""
...
CSV_PATH      = os.path.join(OUT_DIR, "infer_run002_s42_ciclo_completo.csv")
