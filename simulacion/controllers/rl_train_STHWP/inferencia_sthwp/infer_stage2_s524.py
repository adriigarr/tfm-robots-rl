...
Carga run001_s524_stage2_final y evalúa 10 episodios en cada uno de los 28 goals
(280 episodios en total) forzando el goal mediante monkey-patch de _sample_goal_approach.

Salida: inferencia_sthwp/resultados/infer_run001_s524_stage2.csv
"""
...
MODEL_PATH  = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run001_s524_stage2_final")
RUN_ID      = "run001_s524"
N_POR_GOAL  = 100
