"""
Inferencia con obstáculos dinámicos — STH-WP seed=524.
...
y world file con 2 peatones activos (PEDESTRIAN_1, PEDESTRIAN_2).
  ...
  ap+exit : run002_s524_stage4v2_final
  retorno : run002_s524_stage5_final
  50 ep × 28 goals = 1400 ciclos

Salida: inferencia_sthwp/resultados/infer_dinamico_s524.csv
"""
