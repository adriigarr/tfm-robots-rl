"""
Inferencia ciclo completo — run002 seed=123 — INICIO → ESTANTERÍA → DESCARGA → INICIO.
...
Salida: inferencia_sthwp/resultados/infer_run002_s123_ciclo_completo.csv
"""
...
MODEL_S4_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run002_s123_stage4v2_final")
MODEL_S5_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "run002_s123_stage5_final")
RUN_ID        = "run002_s123"
HEADING_SIGMA = 0.25
N_POR_GOAL    = 100
OUT_DIR       = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH      = os.path.join(OUT_DIR, "infer_run002_s123_ciclo_completo.csv")
