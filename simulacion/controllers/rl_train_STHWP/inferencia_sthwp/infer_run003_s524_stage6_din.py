"""
Inferencia ciclo completo dinámico — run003 seed=524 — modelo stage6_din.

Modelo reentrenado con peatones activos. 100 ep × 28 goals = 2800 ciclos.
...
Salida: inferencia_sthwp/resultados/infer_run003_s524_stage6_din.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "run003_s524_stage6_din_final")
RUN_ID     = "run003_s524_din"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_run003_s524_stage6_din.csv")
