"""
INFERENCIA E2.1 — Obs realista (solo LIDAR 5m) | STHWP | SEED=42
Modelo: sthwp_e2_1_s42_final (40 dims)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_1_s42.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_1_s42.csv")
RUN_ID     = "sthwp_e2_1_s42"
N_POR_GOAL = 100
