"""
EXPERIMENTO E1_pred — Observación predictiva P1 | STHWP | SEED=123
...
Base: sthwp_e1_1ped_s123_final (48 dims, 3M steps)
...
LOAD_PATH  = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_1ped_s123_final")
SAVE_PATH  = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_pred_s123_final")
CKPT_DIR   = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_pred_s123")
...
print(f"\n[E1_pred STHWP s123] Weight transplant {OLD_OBS}→{NEW_OBS} dims")
...
new_model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e1_pred_s123"),
        CheckpointCallback(save_freq=100_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e1_pred_s123"),
    ],
    tb_log_name         = "sthwp_e1_pred_s123",
    reset_num_timesteps = False,
)

new_model.save(SAVE_PATH)
print(f"[E1_pred STHWP s123] Guardado en {SAVE_PATH}.zip")
