"""
EXPERIMENTO E1.2 — Sesgo goals problemáticos | STHWP | SEED=123

Base:   sthwp_e1_1ped_s123_final (E1, 88.1% inferencia)
...
Salida: pruebas/sthwp_e1_2_s123_final.zip
"""
...
SAVE_PATH     = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_2_s123_final")
CKPT_DIR      = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_2_s123")
