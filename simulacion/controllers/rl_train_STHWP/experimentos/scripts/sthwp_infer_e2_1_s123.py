"""
INFERENCIA E2.1 — Obs realista (solo LIDAR 5m) | STHWP | SEED=123
Modelo: sthwp_e2_1_s123_final (40 dims)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_1_s123.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_1_s123.csv")
RUN_ID     = "sthwp_e2_1_s123"
N_POR_GOAL = 100
