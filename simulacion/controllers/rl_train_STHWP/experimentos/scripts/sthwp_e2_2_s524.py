"""
EXPERIMENTO E2.2 — A* con replanning LIDAR dinámico | STHWP | SEED=524

Base: sthwp_e2_1_s524_final (40 dims, stage 6, obs realista)
"""
...
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e2_2_s524_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e2_2_s524")

SEED = 524
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E2.2 STHWP s524] Replanning LIDAR dinámico (sin supervisor)")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e2_2_s524"),
        CheckpointCallback(save_freq=200_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e2_2_s524"),
    ],
    tb_log_name         = "sthwp_e2_2_s524",
    reset_num_timesteps = True,
)

model.save(SAVE_PATH)
print(f"[E2.2 STHWP s524] Guardado en {SAVE_PATH}.zip")
