"""
INFERENCIA E2.2 — Replanning LIDAR dinámico | STHWP | SEED=524
Modelo: sthwp_e2_2_s524_final (40 dims)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_2_s524.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e2_2_s524_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_2_s524.csv")
RUN_ID     = "sthwp_e2_2_s524"
N_POR_GOAL = 100
