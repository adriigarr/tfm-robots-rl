"""
INFERENCIA E1 — 1 Peatón | STHWP | SEED=524

Modelo: checkpoints_sthwp_e1_1ped_s524/sthwp_e1_1ped_s524_6502368_steps.zip
        (checkpoint previo al colapso catastrófico — el final.zip colapsó a 7.5M steps)
World:  warehouse_1_1ped.wbt (solo PEDESTRIAN_1 activo)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e1_1ped_s524.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e1_1ped_s524.csv")
RUN_ID     = "sthwp_e1_1ped_s524"
N_POR_GOAL = 100
...
print(f"\n{'='*60}")
print(f" Inferencia E1 1ped | {RUN_ID}")
print(f" {N_GOALS} goals × {N_POR_GOAL} ep = {N_TOTAL} ciclos")
print(f" World: warehouse_1_1ped.wbt (solo PEDESTRIAN_1)")
print(f"{'='*60}\n")
