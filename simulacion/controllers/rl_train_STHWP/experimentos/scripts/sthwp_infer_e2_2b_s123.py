"""
INFERENCIA E2.2b — Replanning LIDAR dinámico (LIDAR_MIN_DYNAMIC=2.5m) | STHWP | SEED=123
Modelo: sthwp_e2_2b_s123_final
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_2b_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e2_2b_s123_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_2b_s123.csv")
RUN_ID     = "sthwp_e2_2b_s123"
N_POR_GOAL = 100
...
print(f"\n{'='*60}")
print(f" Inferencia E2.2b 1ped | {RUN_ID}")
