"""
EXPERIMENTO E1_pred — Observación predictiva P1 | STHWP | SEED=524
...
Base: checkpoints_sthwp_e1_1ped_s524/sthwp_e1_1ped_s524_6502368_steps
      (checkpoint pre-colapso, equivalente al mejor modelo E1 s524)
...
LOAD_PATH  = os.path.join(CONTROLLER_DIR, "pruebas",
                          "checkpoints_sthwp_e1_1ped_s524",
                          "sthwp_e1_1ped_s524_6502368_steps")
SAVE_PATH  = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_pred_s524_final")
CKPT_DIR   = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_pred_s524")
...
print(f"\n[E1_pred STHWP s524] Weight transplant {OLD_OBS}→{NEW_OBS} dims")
...
new_model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e1_pred_s524"),
        CheckpointCallback(save_freq=100_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e1_pred_s524"),
    ],
    tb_log_name         = "sthwp_e1_pred_s524",
    reset_num_timesteps = False,
)

new_model.save(SAVE_PATH)
print(f"[E1_pred STHWP s524] Guardado en {SAVE_PATH}.zip")
