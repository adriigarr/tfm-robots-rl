"""
EXPERIMENTO E1.2 — Sesgo goals problemáticos | STHWP | SEED=524

Base:   checkpoints_sthwp_e1_1ped_s524/sthwp_e1_1ped_s524_6502368_steps (checkpoint pre-colapso)
...
Salida: pruebas/sthwp_e1_2_s524_final.zip
"""
...
SAVE_PATH     = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_2_s524_final")
CKPT_DIR      = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_2_s524")
...
checkpoint_cb = CheckpointCallback(
    ...
    name_prefix="sthwp_e1_2_s524")

print(f"\n[E1.2 STHWP s524] sesgo {PROB_HARD*100:.0f}% goals 24-28 | 1.5M steps")
model.learn(
    total_timesteps=1_500_000,
    reset_num_timesteps=False,
    callback=checkpoint_cb,
    tb_log_name="sthwp_e1_2_s524",
    progress_bar=False,
)
