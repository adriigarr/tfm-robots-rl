"""
EXPERIMENTO E1.5 — Exit-corridor reward + curriculum ponderado | STHWP | SEED=123
...
Base: sthwp_e1_4_s123_final (52 dims, pred_horizon=[1.0,2.0])
"""
...
LOAD_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_4_s123_final")
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_5_s123_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_5_s123")

SEED = 123
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E1.5 STHWP s123] Exit-corridor reward + curriculum ponderado")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e1_5_s123"),
        CheckpointCallback(save_freq=200_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e1_5_s123"),
    ],
    tb_log_name         = "sthwp_e1_5_s123",
    reset_num_timesteps = False,
)

model.save(SAVE_PATH)
print(f"[E1.5 STHWP s123] Guardado en {SAVE_PATH}.zip")
