"""
EXPERIMENTO E1.5 — Exit-corridor reward + curriculum ponderado | STHWP | SEED=524
...
Base: sthwp_e1_4_s524_final (52 dims, pred_horizon=[1.0,2.0])
"""
...
LOAD_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_4_s524_final")
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_5_s524_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_5_s524")

SEED = 524
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E1.5 STHWP s524] Exit-corridor reward + curriculum ponderado")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e1_5_s524"),
        CheckpointCallback(save_freq=200_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e1_5_s524"),
    ],
    tb_log_name         = "sthwp_e1_5_s524",
    reset_num_timesteps = False,
)

model.save(SAVE_PATH)
print(f"[E1.5 STHWP s524] Guardado en {SAVE_PATH}.zip")
