"""
EXPERIMENTO E1.4 — Patience reward + proximidad reforzada | STHWP | SEED=42
...
Base: sthwp_e1_3_s42_final (52 dims, pred_horizon=[1.0,2.0], goal_28 resuelto)
...
LOAD_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_3_s42_final")
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_4_s42_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_sthwp_e1_4_s42")

SEED = 42
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E1.4 STHWP s42] Patience reward + proximidad reforzada")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="sthwp_e1_4_s42"),
        CheckpointCallback(save_freq=100_000, save_path=CKPT_DIR,
                           name_prefix="sthwp_e1_4_s42"),
    ],
    tb_log_name         = "sthwp_e1_4_s42",
    reset_num_timesteps = False,
)

model.save(SAVE_PATH)
print(f"[E1.4 STHWP s42] Guardado en {SAVE_PATH}.zip")
