"""
INFERENCIA E1.2 — 1 Peatón | STHWP | SEED=42

Modelo: sthwp_e1_2_s42_final (sesgo 70% goals 24-28 desde E1)
World:  warehouse_1_1ped.wbt (solo PEDESTRIAN_1 activo)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e1_2_s42.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e1_2_s42_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e1_2_s42.csv")
RUN_ID     = "sthwp_e1_2_s42"
N_POR_GOAL = 100
