"""
INFERENCIA E2.1 SIN PEATÓN — Modelo E2.1 en mundo sin peatón | STHWP | SEED=123
Objetivo: medir tasa base (sin obstáculo dinámico) para cuantificar el impacto del peatón.
Modelo: sthwp_e2_1_s123_final (40 dims, LIDAR only)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_1_noped_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "sthwp_e2_1_s123_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_1_noped_s123.csv")
RUN_ID     = "sthwp_e2_1_noped_s123"
N_POR_GOAL = 100
...
print(f"\n{'='*60}")
print(f" Inferencia E2.1 SIN PEATÓN | {RUN_ID}")
