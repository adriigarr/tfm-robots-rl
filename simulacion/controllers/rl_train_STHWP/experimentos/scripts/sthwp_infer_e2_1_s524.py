"""
INFERENCIA E2.1 — Obs realista (solo LIDAR 5m) | STHWP | SEED=524
Modelo: sthwp_e2_1_s524_final (40 dims)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/sthwp_infer_e2_1_s524.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "sthwp_infer_e2_1_s524.csv")
RUN_ID     = "sthwp_e2_1_s524"
N_POR_GOAL = 100
