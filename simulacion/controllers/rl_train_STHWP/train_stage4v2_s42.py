"""
ETAPA 4 v2 — Ciclo completo integrado (70% approach / 30% exit).   ~4M steps  |  SEED=42

Requiere: pruebas/run002_s42_stage3v2_final.zip
...
Salida: pruebas/run002_s42_stage4v2_final.zip
"""
