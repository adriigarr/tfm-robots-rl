"""
ETAPA 6 — Ciclo completo estático (approach→exit→return).  1M steps  |  SEED=123

Requiere: pruebas/run002_s123_stage4v2_final.zip
...
Salida: pruebas/run002_s123_stage6_final.zip
"""
