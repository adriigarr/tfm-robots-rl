"""
ETAPA 4 v2 — Ciclo completo integrado (70% approach / 30% exit).   ~4M steps  |  SEED=524

Requiere: pruebas/run002_s524_stage3v2_final.zip
...
Salida: pruebas/run002_s524_stage4v2_final.zip
"""
