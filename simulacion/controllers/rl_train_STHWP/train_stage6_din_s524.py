"""
ETAPA 6 DIN — Ciclo completo con peatones (fine-tuning dinámico).  1M steps  |  SEED=524

Requiere: pruebas/run003_s524_stage6_final.zip
...
Salida: pruebas/run003_s524_stage6_din_final.zip
"""
