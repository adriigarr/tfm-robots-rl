"""
ETAPA 4 — Ciclo completo integrado (70% approach / 30% exit).   ~4M steps  |  SEED=123

Requiere: pruebas/subwp_s123_wp75_stage3_final.zip
          inferencia_subwp/resultados/arrival_headings_stage2.json

Salida: pruebas/subwp_s123_stage4_final.zip
"""
