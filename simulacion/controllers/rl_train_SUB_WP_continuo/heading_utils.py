...
def heading_to_webots_rotation(heading_rad):
    ...
    Las estanterías y paredes usan 'rotation 0 0 1 angle' para orientarse,
    y el viewpoint está a z=75m mirando hacia abajo, confirmando Z=arriba.
    ...
    alrededor del eje Y horizontal. Para ángulos pequeños (stage 3-4) el
    pitch era tolerable; para θ≈-108° (stage 5) el robot volcaba y el
    bumper penetraba el suelo, disparando colisión en el paso 1.
    """
