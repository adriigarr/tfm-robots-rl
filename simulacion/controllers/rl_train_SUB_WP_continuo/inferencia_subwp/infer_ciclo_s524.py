"""
Inferencia ciclo completo — SUB-WP seed=524.

Modelo: subwp_s524_wp75_stage5_final (conoce approach + exit + return)
...
Salida: inferencia_subwp/resultados/infer_subwp_s524_wp75_ciclo.csv
"""
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas",
                          "subwp_s524_wp75_stage5_final")
RUN_ID      = "subwp_s524_wp75"
N_POR_GOAL  = 100
OUT_DIR     = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH    = os.path.join(OUT_DIR, "infer_subwp_s524_wp75_ciclo.csv")
