"""
Inferencia dinámica v4 — SUB-WP seed=123 — con logging de replanning por fase.

Igual que infer_din_v4_s123.py pero registra por episodio:
...
Salida:
  resultados/infer_din_v4_s123_replanlog.csv   (detalle por episodio)
  resultados/infer_din_v4_s123_replanlog_summary.txt
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s123_wp75_stage6_din_v4_final")
RUN_ID     = "din_v4_s123_replanlog"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v4_s123_replanlog.csv")
TXT_PATH   = os.path.join(OUT_DIR, "infer_din_v4_s123_replanlog_summary.txt")
