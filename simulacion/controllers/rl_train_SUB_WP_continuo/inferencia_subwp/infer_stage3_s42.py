"""
Inferencia stage 3 — SUB-WP seed=42 — Exit puro, política determinista.

100 episodios por goal × 28 goals = 2800 episodios.
Salida: inferencia_subwp/resultados/infer_subwp_s42_wp75_stage3.csv
"""
...
MODEL_PATH    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "subwp_s42_wp75_stage3_final")
RUN_ID        = "subwp_s42_wp75"
STAGE         = 3
HEADING_SIGMA = 0.25
N_POR_GOAL    = 100
OUT_DIR       = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH      = os.path.join(OUT_DIR, "infer_subwp_s42_wp75_stage3.csv")
