"""
Inferencia dinámica v3 + REPLANIFICACIÓN — SUB-WP s123.

Modelo: subwp_s123_wp75_stage6_din_v3_final  Baseline: 38.3%

Salida: inferencia_subwp/resultados/infer_din_v3_s123_replanning.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s123_wp75_stage6_din_v3_final")
RUN_ID   = "subwp_s123_din_v3_replanning"
N_POR_GOAL = 100
OUT_DIR  = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH = os.path.join(OUT_DIR, "infer_din_v3_s123_replanning.csv")
...
print(f"\n  COMPARATIVA:")
print(f"    v3 sin replanning (baseline):  38.3%")
