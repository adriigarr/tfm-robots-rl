...
Salida: inferencia_subwp/resultados/infer_subwp_s42_wp75_stage5.csv
"""
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "subwp_s42_wp75_stage5_final")
RUN_ID     = "subwp_s42_wp75"
STAGE      = 5
N_EP       = 300
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_subwp_s42_wp75_stage5.csv")
