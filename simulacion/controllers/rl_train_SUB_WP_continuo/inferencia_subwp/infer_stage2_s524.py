"""
Inferencia stage 2 — SUB-WP seed=524 — Approach puro, todos los goals.
...
Salida: inferencia_subwp/resultados/infer_subwp_s524_stage2.csv
"""
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "subwp_s524_stage2_final")
RUN_ID     = "subwp_s524"
STAGE      = 2
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_subwp_s524_stage2.csv")
