"""
Inferencia dinámica v4 — SUB-WP seed=123 — replanning integrado.

Modelo: subwp_s123_wp75_stage6_din_v4_final (final tras 2M steps con replanning
...
Salida: inferencia_subwp/resultados/infer_din_v4_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas",
                          "subwp_s123_wp75_stage6_din_v4_final")
RUN_ID     = "din_v4_s123_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v4_s123.csv")
