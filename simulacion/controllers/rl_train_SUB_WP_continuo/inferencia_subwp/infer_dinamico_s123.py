...
Modelo: subwp_s123_wp75_stage5_final (approach + exit + return, stage=6)

Salida: inferencia_subwp/resultados/infer_dinamico_s123.csv
"""
...
RUN_ID     = "dinamico_s123_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(CONTROLLER_DIR, "inferencia_subwp", "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_dinamico_s123.csv")
...
print(f" Modelo: subwp_s123_wp75_stage5_final  |  Stage=6  |  det=True")
