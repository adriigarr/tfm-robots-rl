"""
Inferencia stage 1 — SUB-WP seed=42 — Approach puro, goal_01.

500 episodios sobre goal_01 (único goal entrenado en stage 1).

Salida: inferencia_subwp/resultados/infer_subwp_s42_stage1.csv
"""
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "subwp_s42_stage1_final")
RUN_ID     = "subwp_s42"
N_EP       = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_subwp_s42_stage1.csv")

env   = WebotsEnv(map_path=MAP_PATH, stage=1)
model = PPO.load(MODEL_PATH, env=env)

# fijar goal_01 (índice 0)
