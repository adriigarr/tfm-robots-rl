"""
Inferencia dinámica v2 — SUB-WP seed=42 — modelo stage6_din_v2.
...
Salida: inferencia_subwp/resultados/infer_din_v2_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s123_wp75_stage6_din_v2_final")
RUN_ID     = "din_v2_s123_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v2_s123.csv")
...
print(f"\n{'='*60}")
print(f" Inferencia DINÁMICA v2 | {RUN_ID}")
