"""
Inferencia stage 6 din v4 r2 — SUB-WP seed=524 — Ciclo completo SIN peatones físicos.
...
Salida: inferencia_subwp/resultados/infer_din_v4_r2_noped_s524.csv
"""
...
RUN_ID     = "din_v4_r2_noped_s524"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v4_r2_noped_s524.csv")
