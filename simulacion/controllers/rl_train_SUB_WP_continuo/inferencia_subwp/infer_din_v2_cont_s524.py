"""
Inferencia dinámica v2_cont — SUB-WP seed=524 — modelo stage6_din_v2_cont.

Modelo continuado 3M steps desde din_v2_final (48 dims, ~4M steps totales).
Carga: subwp_s524_wp75_stage6_din_v2_cont_final (final — curva estable).
100 ep × 28 goals = 2800 ciclos. World: warehouse_1_subwp.wbt.

Salida: inferencia_subwp/resultados/infer_din_v2_cont_s524.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas",
                          "subwp_s524_wp75_stage6_din_v2_cont_final")
RUN_ID     = "din_v2_cont_s524_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v2_cont_s524.csv")
