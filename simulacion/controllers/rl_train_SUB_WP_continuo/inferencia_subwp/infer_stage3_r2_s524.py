...
Salida: inferencia_subwp/resultados/infer_subwp_s524_wp75_r2_stage3.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s524_wp75_r2_stage3_final")
RUN_ID     = "subwp_s524_wp75_r2"
STAGE      = 3
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_subwp_s524_wp75_r2_stage3.csv")
