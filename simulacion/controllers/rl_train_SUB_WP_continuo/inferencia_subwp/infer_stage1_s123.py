"""
Inferencia stage 1 — SUB-WP seed=123 — Approach puro, goal_01.

500 episodios sobre goal_01.

Salida: inferencia_subwp/resultados/infer_subwp_s123_stage1.csv
"""
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "pruebas", "subwp_s123_stage1_final")
RUN_ID     = "subwp_s123"
N_EP       = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_subwp_s123_stage1.csv")
