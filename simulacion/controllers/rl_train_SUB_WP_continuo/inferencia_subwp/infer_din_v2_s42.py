...
Salida: inferencia_subwp/resultados/infer_din_v2_s42.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s42_wp75_stage6_din_v2_final")
RUN_ID     = "din_v2_s42_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v2_s42.csv")
