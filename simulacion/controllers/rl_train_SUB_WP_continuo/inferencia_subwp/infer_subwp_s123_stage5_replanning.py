"""
Inferencia v1 estático + REPLANIFICACIÓN — SUB-WP s123, peatones congelados.

Modelo: subwp_s123_wp75_stage5_final (v1, ped_obs=False, 40 dims).
Salida: inferencia_subwp/resultados/infer_subwp_s123_stage5_replanning.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s123_wp75_stage5_final")
RUN_ID   = "subwp_s123_static_replanning"
N_POR_GOAL = 100
OUT_DIR  = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH = os.path.join(OUT_DIR, "infer_subwp_s123_stage5_replanning.csv")
