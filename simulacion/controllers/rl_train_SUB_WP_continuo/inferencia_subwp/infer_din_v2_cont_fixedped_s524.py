...
Modelo: subwp_s524_wp75_stage6_din_v2_cont_final (48 dims).
...
Salida: inferencia_subwp/resultados/infer_din_v2_cont_fixedped_s524.csv
"""
...
RUN_ID     = "din_v2_cont_fixedped_s524_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v2_cont_fixedped_s524.csv")
