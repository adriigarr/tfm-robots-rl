"""
Inferencia stage 6 din v4 r2 — SUB-WP seed=42 — Ciclo completo + peatones + replanning | dropoff corregido.

100 ep × 28 goals = 2800 ciclos. World: warehouse_1_subwp.wbt.
Salida: inferencia_subwp/resultados/infer_din_v4_r2_s524.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s524_wp75_r2_stage6_din_v4_final")
RUN_ID     = "din_v4_r2_s524_subwp"
N_POR_GOAL = 100
OUT_DIR    = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "infer_din_v4_r2_s524.csv")
...
print(f"\n{'='*60}")
print(f" Inferencia dinámica v4 r2 | {RUN_ID}")
