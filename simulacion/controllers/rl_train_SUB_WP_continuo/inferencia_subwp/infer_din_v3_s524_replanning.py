"""
Inferencia dinámica v3 + REPLANIFICACIÓN — SUB-WP s524.

Modelo: subwp_s524_wp75_stage6_din_v3_final  Baseline: 39.8%

Salida: inferencia_subwp/resultados/infer_din_v3_s524_replanning.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_s524_wp75_stage6_din_v3_final")
RUN_ID   = "subwp_s524_din_v3_replanning"
N_POR_GOAL = 100
OUT_DIR  = os.path.join(os.path.dirname(__file__), "resultados")
CSV_PATH = os.path.join(OUT_DIR, "infer_din_v3_s524_replanning.csv")
