"""
ETAPA 4 — Ciclo completo integrado (70% approach / 30% exit).   ~4M steps  |  SEED=42

Requiere: pruebas/subwp_s42_wp75_stage3_final.zip
          inferencia_subwp/resultados/arrival_headings_stage2.json

Objetivo: ciclo approach→exit encadenado sobre los 28 goals.

Salida: pruebas/subwp_s42_stage4_final.zip
"""
