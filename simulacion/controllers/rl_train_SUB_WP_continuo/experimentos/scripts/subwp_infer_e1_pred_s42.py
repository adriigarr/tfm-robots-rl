...
Modelo: subwp_e1_pred_s42_final (52 dims, pred_horizon=[1.0, 2.0])
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/subwp_infer_e1_pred_s42.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_pred_s42_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "subwp_infer_e1_pred_s42.csv")
RUN_ID     = "subwp_e1_pred_s42"
N_POR_GOAL = 100
