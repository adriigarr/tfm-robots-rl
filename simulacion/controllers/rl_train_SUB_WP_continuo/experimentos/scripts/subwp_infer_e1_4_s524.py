...
Modelo: subwp_e1_4_s524_final (sesgo 70% goals 19-22+24-28 desde E1)
World:  warehouse_1_subwp_1ped.wbt (solo PEDESTRIAN_1 activo)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/subwp_infer_e1_4_s524.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_4_s524_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "subwp_infer_e1_4_s524.csv")
RUN_ID     = "subwp_e1_4_s524"
N_POR_GOAL = 100
