"""
EXPERIMENTO E1.2 — Sesgo goals problemáticos | SUB-WP | SEED=524

Base:   subwp_e1_1ped_s524_final (E1, 76.9% inferencia)
...
Salida: pruebas/subwp_e1_2_s524_final.zip
...
SAVE_PATH      = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_2_s524_final")
CKPT_DIR       = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_subwp_e1_2_s524")
