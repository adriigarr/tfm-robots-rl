"""
EXPERIMENTO E1.4 — Patience reward + proximidad reforzada + replan agresivo | SUBWP | SEED=42
...
Base: subwp_e1_3_s42_final (48 dims, mejor SUBWP actual 81.6%)
...
LOAD_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_3_s42_final")
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_4_s42_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_subwp_e1_4_s42")

SEED = 42
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E1.4 SUBWP s42] Patience reward + replan agresivo")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="subwp_e1_4_s42"),
        CheckpointCallback(save_freq=100_000, save_path=CKPT_DIR,
                           name_prefix="subwp_e1_4_s42"),
    ],
    tb_log_name         = "subwp_e1_4_s42",
    reset_num_timesteps = False,
)

model.save(SAVE_PATH)
print(f"[E1.4 SUBWP s42] Guardado en {SAVE_PATH}.zip")
