...
Base: subwp_e1_2_s42_final (48 dims — mejor modelo SUBWP, E1.2)
...
LOAD_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_2_s42_final")
SAVE_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_3_s42_final")
CKPT_DIR  = os.path.join(CONTROLLER_DIR, "pruebas", "checkpoints_subwp_e1_3_s42")

SEED = 42
random.seed(SEED); np.random.seed(SEED); torch.manual_seed(SEED)

print(f"\n[E1.3 SUBWP s42] Trayectoria P1 extendida x∈[-4,4]")
...
model.learn(
    ...
    callback            = [
        StatsCallback(goal_ids=env.goal_ids, stage=6, run_id="subwp_e1_3_s42"),
        CheckpointCallback(save_freq=100_000, save_path=CKPT_DIR,
                           name_prefix="subwp_e1_3_s42"),
    ],
    tb_log_name         = "subwp_e1_3_s42",
    reset_num_timesteps = False,
)

model.save(SAVE_PATH)
print(f"[E1.3 SUBWP s42] Guardado en {SAVE_PATH}.zip")
