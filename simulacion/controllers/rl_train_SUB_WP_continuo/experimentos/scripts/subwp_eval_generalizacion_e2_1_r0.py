"""
EVALUACIÓN E2.1-R0 | SUBWP — replanificación dinámica DESACTIVADA
Variante de subwp_eval_generalizacion.py (E2.1-R1, replanning LIDAR activo)
...
cada tramo (approach/exit/return) NO se toca, sigue funcionando igual. El
avance normal por la secuencia de waypoints de SUB-WP tampoco se toca.
...
exactamente los mismos checkpoints finales que E2.1-R1:
  pruebas/subwp_e2_1_s{42,123,524}_final.zip
...
# subwp_eval_generalizacion.py — no se cambia nada de la geometría/peatón.
PED_RANGES = {
...
RUN_ID     = f"subwp_eval_gen_e2_1_r0_wh{WH}_s{SEED}"
...
for goal_idx in goal_indices:
    ...
    for rep in range(1, n_reps_run + 1):
        ...
        episode_seed = derive_episode_seed("subwp", SEED, WH, goal_idx, rep)
        ep_global += 1
        ...
        with open(CSV_PATH, "a", newline="") as f:
            csv.DictWriter(f, fieldnames=FIELDS).writerow({
                ...
                "warehouse_id": WH, "metodo": "subwp", "seed": SEED, "peaton": 1,
                "policy_stage": "E2.1", "evaluation_variant": "E2.1-R0",
                "dynamic_replanning": False,
                "architecture": "subwp", "model_seed": SEED, "warehouse": WH,
