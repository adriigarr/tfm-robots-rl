"""
INFERENCIA E2.2b — Replanning LIDAR dinámico (LIDAR_MIN_DYNAMIC=2.5m) | SUBWP | SEED=123
Modelo: subwp_e2_2b_s123_final
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/subwp_infer_e2_2b_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e2_2b_s123_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "subwp_infer_e2_2b_s123.csv")
RUN_ID     = "subwp_e2_2b_s123"
N_POR_GOAL = 100
