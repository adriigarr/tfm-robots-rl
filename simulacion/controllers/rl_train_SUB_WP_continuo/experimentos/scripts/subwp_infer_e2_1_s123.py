"""
INFERENCIA E2.1 — Obs realista (solo LIDAR 5m) | SUBWP | SEED=123
Modelo: subwp_e2_1_s123_final (40 dims)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/subwp_infer_e2_1_s123.csv
"""
...
CSV_PATH   = os.path.join(OUT_DIR, "subwp_infer_e2_1_s123.csv")
RUN_ID     = "subwp_e2_1_s123"
N_POR_GOAL = 100
...
print(f"\n{'='*60}")
print(f" Inferencia E2.1 1ped | {RUN_ID}")
