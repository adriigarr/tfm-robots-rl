"""
INFERENCIA E1 — 1 Peatón | SUB-WP | SEED=42

Modelo: subwp_e1_1ped_s123_final
World:  warehouse_1_subwp_1ped.wbt (solo PEDESTRIAN_1 activo)
100 ep × 28 goals = 2800 ciclos.
CSV: experimentos/resultados/subwp_infer_e1_1ped_s123.csv
"""
...
MODEL_PATH = os.path.join(CONTROLLER_DIR, "pruebas", "subwp_e1_1ped_s123_final")
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(__file__)), "resultados")
CSV_PATH   = os.path.join(OUT_DIR, "subwp_infer_e1_1ped_s123.csv")
RUN_ID     = "subwp_e1_1ped_s123"
N_POR_GOAL = 100
...
print(f" World: warehouse_1_subwp_1ped.wbt (solo PEDESTRIAN_1)")
print(f"{'='*60}\n")
