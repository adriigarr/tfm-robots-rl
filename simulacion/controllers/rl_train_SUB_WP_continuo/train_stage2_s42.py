"""
ETAPA 2 — Approach puro, todos los goals.   ~4M steps  |  SEED=42

Requiere: pruebas/subwp_s42_stage1_final.zip

Objetivo: generalizar el approach a los 28 goals del almacén con sesgo
PROB_SHELF_DIFICIL=0.7 hacia goals de bloques 3 y 5.
Episodio termina al llegar a la estantería. Sin exit.

Salida: pruebas/subwp_s42_stage2_final.zip
"""
