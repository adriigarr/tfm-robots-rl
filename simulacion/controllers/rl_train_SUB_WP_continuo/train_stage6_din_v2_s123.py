"""
ETAPA 6 DIN v2 — Ciclo completo + esquiva real (Opción 1 + Opción A) | SEED=123
...
Mejoras sobre v1:
  ...
  - Transferencia de pesos: subwp_s123_wp75_stage5_final (40d) → red expandida (48d)

World: warehouse_1_subwp.wbt (PEDESTRIAN_1 + PEDESTRIAN_2 activos)
Salida: pruebas/subwp_s123_wp75_stage6_din_v2_final.zip
"""
